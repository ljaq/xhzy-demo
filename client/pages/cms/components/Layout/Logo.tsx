...
export default function Logo({ style }: { style: CSSProperties }) {
  const {
    token: { colorPrimaryActive, colorPrimaryHover },
  } = theme.useToken()
  return (
    <svg version='1.2' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' width='512' height='512' style={style}>
      <defs>
        <linearGradient
          ...
          gradientTransform='matrix(195.849,182.633,-119.439,128.082,91.972,264.272)'
        >
          <stop offset='0' stopColor={colorPrimaryActive} />
          <stop offset='.6' stopColor={colorPrimaryHover} />
        </linearGradient>
        <linearGradient
          id='g2'
          x2='1'
          gradientUnits='userSpaceOnUse'
          gradientTransform='matrix(279.963,75.016,-60.524,225.88,102.041,152.02)'
        >
          <stop offset='0' stopColor={colorPrimaryHover} />
          <stop offset='.6' stopColor={colorPrimaryActive} />
        </linearGradient>
        <linearGradient
          id='g3'
          x2='1'
          gradientUnits='userSpaceOnUse'
          gradientTransform='matrix(99.931,-173.085,235.303,135.852,281.853,257.669)'
        >
          <stop offset='0' stopColor={colorPrimaryActive} />
          <stop offset='1' stopColor={colorPrimaryHover} />
        </linearGradient>
        <linearGradient
          id='g4'
          x2='1'
          gradientUnits='userSpaceOnUse'
          gradientTransform='matrix(129.307,-223.967,153.658,88.714,322.893,360.107)'
        >
          <stop offset='0' stopColor={colorPrimaryHover} />
          <stop offset='0.4' stopColor={colorPrimaryActive} />
        </linearGradient>
      </defs>
      <path
        className='s0'
      ...
      <path
        className='s2'
        fill='url(#g3)'
        d='m231.5 71.3c-5.9 0.2 84.5 31.2 110.5 59.7 6.8 7.5 11 16 11 16 7.6 15.5 7.1 29.9 7 36-0.5 22.5 0.5 74.8 0.5 139.7 9.2 11.7 17 16 24.5 15 22.8-3.1 37.7-67.8 44.7-188.9 0.2-3-1-6-3.3-8-7.5-6.7-16.6-14.2-27.4-21.8 0 0-21.7-15.2-45-25.9-53.5-24.7-118.4-22-122.5-21.8z'
      />
      <path
        className='s3'
        fill='url(#g4)'
